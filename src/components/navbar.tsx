...
<nav className="bg-white fixed w-full border-b-1  border-[#FF7B06] z-20 top-0 start-0 dark:bg-gray-900">
  <div className="max-w-screen-xl flex flex-wrap justify-between items-center mx-auto py-2 px-4">
    ...
    <div className="hidden w-full md:block md:w-auto md:ml-[10rem] lg:ml-[20rem]" id="navbar-default">
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li className="lg:hidden">
          <a href="#" className="block  text-[#FF7B06]  py-2 px-3 rounded-sm  md:p-0 "><img src={cart} alt="cart" className="h-[1rem] md:mt-[-0.8rem] "/></a>
        </li>
